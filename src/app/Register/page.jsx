...
export default function PlansPage() {
  ...
  const guideApi = async () => {
    try {
      const response = await axios.get("https://admin.agingcongress.org/api/guide-plans");
...
useEffect(()=>{
  ...
  useEffect(() => {
    ...
    axios.get("https://admin.agingcongress.org/api/getPlans").then((response) => {
    ...
    axios.get("https://admin.agingcongress.org/api/getAccommodations").then((response) => setAccommodations(response.data));
  }, []);
  ...
  const handleStripePayment = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://admin.agingcongress.org/api/register-and-pay", {
        formData,
            ...
            >
              <PayPalButtons
                ...
                createOrder={async (data, actions) => {
                  try {
                    const response = await axios.post(
                      "https://admin.agingcongress.org/api/create-paypal-order",
                      {
                        formData,
                        selectedPlan: {
                          planId: activePlanId,
                ...
                onApprove={async (data) => {
                  try {
                    const response = await axios.post("https://admin.agingcongress.org/api/capture-paypal-order", {
