...
const AgendaPage = () => {
        ...
        const fetchAgendas = async () => {
            try {
                ...
                if (response.data.agendas?.length) {
                    setSelectedPdf(`https://admin.agingcongress.org${response.data.agendas[0].pdf}`); // Set the first PDF as default
                }
            } catch (error) {
    ...
    const handleDateClick = (pdfUrl) => {
        setSelectedPdf(`https://admin.agingcongress.org${pdfUrl}`);
    };
